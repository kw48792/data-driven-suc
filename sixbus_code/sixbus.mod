...
param DCfldual{T,S,1..(NBUSES-1),1..nCutOpt} default 0;
...
Min_Stage2_Profit >= 1/N_SCEN*(
                     ...
                     sum{b in 1..(NBUSES-1), t in T, s in S} DCfldual[t,s,b,ncut]*(LOAD[b,t])+
...
subject to DCfl{t in T, s in S, b in 1..(NBUSES-1)}: sum{i in I} GENMAP[i,b]*p[i,t,s]+sum{w in WG} WINDMAP[w,b]*wg[w,t,s]+ens[b,t,s]-sum{bb in 1..(NBUSES-1)} BMATRIX[b,bb]*theta[bb,t,s]=LOAD[b,t];
...
subject to linecap1{l in L, t in T, s in S}:  -LINEADM[l] * sum {b in B: LINEMAP[l,b] <> 0} theta[b,t,s]*LINEMAP[l,b]>=-LINECAP [l]; 
subject to linecap2{l in L, t in T, s in S}:  LINEADM[l] * sum {b in B: LINEMAP[l,b] <> 0} theta[b,t,s]*LINEMAP[l,b]>=-LINECAP [l]; 
...
# DC flow constant Equation~(8).
subject to DCflT{t in T, s in SS, b in 1..(NBUSES-1)}: sum{i in I} GENMAP[i,b]*pT[i,t,s]+sum{w in WG} WINDMAP[w,b]*wgT[w,t,s]+ensT[b,t,s]-sum{bb in 1..(NBUSES-1)} BMATRIX[b,bb]*thetaT[bb,t,s]=LOAD[b,t];
...
subject to linecap1T{l in L, t in T, s in SS}:  -LINEADM[l] * sum {b in B: LINEMAP[l,b] <> 0} thetaT[b,t,s]*LINEMAP[l,b]>=-LINECAP [l]; 
subject to linecap2T{l in L, t in T, s in SS}:  LINEADM[l] * sum {b in B: LINEMAP[l,b] <> 0} thetaT[b,t,s]*LINEMAP[l,b]>=-LINECAP [l]; 
